...
if game_name:
    ...
    if game and isinstance(game, dict):
        game_id = game.get('id')
        if not game_id:
            st.error("Game ID not found. Try another title.")
        else:
            ...
            game_details = client.get_game_details(game_id)
            ...
            # Screenshots
            screenshots = client.get_game_screenshots(game_id)
            if screenshots:
            ...
            # Achievements
            achievements = client.get_achievements_by_game_id(game_id)
        ...
        st.error("Game not found or invalid response. Please check the name and try again.")
